...
INSERT INTO `note` (`id`, `user_id`, `category_id`, `amount`, `org_content`, `status`, `created_at`, `updated_at`) VALUES (31, 1, 1, 16.00, '吴晶晶中午吃了16块的米线', 0, '2025-01-08 17:36:17', '2025-01-08 17:36:17');
...
INSERT INTO `note` (`id`, `user_id`, `category_id`, `amount`, `org_content`, `status`, `created_at`, `updated_at`) VALUES (169, 6, 13, 200.00, '意外支出:200.0||被交警逮住罚了200', 0, '2025-01-15 11:09:01', '2025-01-15 11:09:01');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `user` (`id`, `name`, `status`, `open_id`) VALUES (1, 'wanna', 0, '12345');
INSERT INTO `user` (`id`, `name`, `status`, `open_id`) VALUES (2, '王厚伟', 0, NULL);
INSERT INTO `user` (`id`, `name`, `status`, `open_id`) VALUES (3, 'wjj1', NULL, '');
INSERT INTO `user` (`id`, `name`, `status`, `open_id`) VALUES (4, 'ashui', NULL, '');
INSERT INTO `user` (`id`, `name`, `status`, `open_id`) VALUES (5, '我叫', NULL, '');
INSERT INTO `user` (`id`, `name`, `status`, `open_id`) VALUES (6, 'oPciXvwvLAtqtiXT3Gmx_j8q-jmM', NULL, '');
INSERT INTO `user` (`id`, `name`, `status`, `open_id`) VALUES (7, 'oPciXv9cBjww85E4BOtIw1FroOrg', NULL, '');
INSERT INTO `user` (`id`, `name`, `status`, `open_id`) VALUES (8, '44774b67-5224-419b-8466-b60724fced1e', NULL, '');
INSERT INTO `user` (`id`, `name`, `status`, `open_id`) VALUES (9, 'oPciXv4V8wbKoZHSGPuf_Uc3dnwQ', NULL, '');
INSERT INTO `user` (`id`, `name`, `status`, `open_id`) VALUES (10, 'c39d726a-b1ce-466c-99b7-f36309cbc320', NULL, '');
COMMIT;
